...
//        given(articleRepository.getById(dto.getId())).willReturn(article);
//        given(userAccountRepository.getById(dto.getUserAccountDto().getUserId())).willReturn(dto.getUserAccountDto().toEntity());
//
//        // When
...
//        then(articleRepository).should().getById(dto.getId());
//        then(userAccountRepository).should().getById(dto.getUserAccountDto().getUserId());
//    }
//
...
//        // Given
//        ArticleDto dto = createArticleDto("새 타이틀", "새 내용", "#springboot");
//        given(articleRepository.getById(dto.getId())).willThrow(EntityNotFoundException.class);
//
//        // When
//        sut.updateArticle(dto.getId(), dto);
//
